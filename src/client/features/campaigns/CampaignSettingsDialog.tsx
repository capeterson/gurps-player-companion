          ...
          {viewerRole === 'owner' && (
            <label className="form-control">
              ...
              <span className="label-text-alt text-xs text-base-content/60">
                ...
                requires energy up front, restores mages' personal FP spent on their own turn next
                turn, and makes every failure critical. Applied to every character sheet in this
                campaign.
              </span>
            </label>
          )}
